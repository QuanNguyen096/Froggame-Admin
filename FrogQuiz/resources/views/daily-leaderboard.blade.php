...
<html lang="en">
    <head>
        ...
        <title>Daily Leaderboard Details  | Qearner - Learn More Earn More - Admin Panel </title>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <!-- FavIcon -->
                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Daily Leaderboard Details <small>View day wise leaderboard</small></h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    ...
                                    <table aria-describedby="mydesc" class='table-striped' id='daily_leaderboard'
                                           ...
                                           data-export-options='{
                                           "fileName": "daily-leaderboard-list-20-11-22",
                                           "ignoreColumn": ["state"]	
                                           }'
