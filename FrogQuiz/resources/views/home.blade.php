...
<html lang="en">
    ...
    <body class="nav-md">
        ...
        <!-- /top navigation -->                <!-- page content -->
                <div class="right_col" role="main" aria-labelledby="mainnavheading">
                    ...
                    <div class="row">
                        <div role="main" aria-labelledby="mainnavheading">
                            <!-- top tiles -->
                            <h1 style="color:black;font-size:29px;text-align:center;">Chào mừng đến với Frog Quiz - Admin Panel</h1>
                            <hr>
            ...
            <!-- Sweet Alert 2  -->
            <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js" integrity="sha256-KsRuvuRtUVvobe66OFtOQfjP8WA2SzYsmm4VPfMnxms=" crossorigin="anonymous"></script>        </div>
        <!-- jQuery -->
            ...
            <script type="text/javascript">
                ...
                function drawChart() {
                    var data = google.visualization.arrayToDataTable([
                        ['Month', 'Participated'],
                        ['January',37],['February',243],['March',148],['April',141],['May',136],['June',181],['July',137],['August',162],['September',98],['October',134],['November',15],                    ]);
                    var options = {
                        chart: {
                            title: 'Monthly Leaderboard',
                            subtitle: 'Total Users Participated in Quiz Month Wise (Year: 2022)',
                        }
                    };
                ...
                function drawChart1() {
                    var data = google.visualization.arrayToDataTable([
                        ['Month', 'Registered'],
                        ['January',170],['February',482],['March',266],['April',241],['May',225],['June',268],['July',228],['August',219],['September',144],['October',206],['November',30],                    ]);
                    var options = {
                        chart: {
                            title: 'Monthly Registered Users',
                            subtitle: 'Total Users Registered Month Wise (Year: 2022)',
                        }
                    };
